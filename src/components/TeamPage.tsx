    ...
    <div className="w-full space-y-8 animate-in fade-in duration-200">
      ...
      <div className="w-full bg-white dark:bg-[#111827] border border-[#e5e5e7] dark:border-[#1f2937] rounded-3xl p-6 sm:p-10 shadow-xs space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="p-6 rounded-2xl bg-[#fbfbfd] dark:bg-[#151d2f] border border-[#e5e5e7] dark:border-[#1f2937] space-y-3">
        ...
        <div className="border-t border-[#e5e5e7] dark:border-[#1f2937] pt-8 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="text-xs font-bold text-[#1d1d1f] dark:text-white uppercase tracking-wider">
                {t.logoAnatomyTitle}
              </span>
              <p className="text-xs text-[#86868b] dark:text-[#9ca3af]">{t.logoAnatomyDesc}</p>
            </div>

            <div className="p-4 bg-[#f5f5f7] dark:bg-[#151d2f] rounded-2xl border border-[#e5e5e7] dark:border-[#1f2937] flex items-center gap-3 shrink-0">
              <img src="/favicon.svg" alt="Terra Harmonia Logo" className="w-10 h-10" />
              <div className="text-left text-xs">
                <span className="font-bold text-[#1d1d1f] dark:text-white block text-sm">Terra Harmonia</span>
                <span className="text-[#86868b] dark:text-[#9ca3af]">Official NASA Hackathon Emblem</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            ...
            <div className="p-5 rounded-2xl border border-[#e5e5e7] dark:border-[#1f2937] bg-[#fbfbfd] dark:bg-[#151d2f] space-y-2">
              <div className="flex items-center gap-2">
                <span className="w-3.5 h-3.5 rounded-full bg-emerald-500 shrink-0" />
                <strong className="text-sm text-[#1d1d1f] dark:text-white">{t.crescentTitle}</strong>
              </div>
            ...
            <div className="p-5 rounded-2xl border border-[#e5e5e7] dark:border-[#1f2937] bg-[#fbfbfd] dark:bg-[#151d2f] space-y-2">
              <div className="flex items-center gap-2">
                ...
                <strong className="text-sm text-[#1d1d1f] dark:text-white">{t.flameTitle}</strong>
              </div>
              <p className="text-[#6e6e73] dark:text-[#9ca3af] leading-relaxed">
                {t.flameDesc}
              </p>
            ...
            <div className="p-5 rounded-2xl border border-[#e5e5e7] dark:border-[#1f2937] bg-[#fbfbfd] dark:bg-[#151d2f] space-y-2">
              <div className="flex items-center gap-2">
                ...
                <strong className="text-sm text-[#1d1d1f] dark:text-white">{t.orbitRingTitle}</strong>
              </div>
              <p className="text-[#6e6e73] dark:text-[#9ca3af] leading-relaxed">
                {t.orbitRingDesc}
              </p>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <h3 className="text-lg font-bold text-[#1d1d1f] dark:text-white">{member.name}</h3>
                    <p className="text-xs font-bold text-blue-700 dark:text-blue-400 mt-0.5">
                      {language === 'id' ? member.roleId : member.roleEn}
                    </p>
                  </div>
                  <div className="p-2.5 bg-white dark:bg-[#111827] rounded-xl border border-[#e5e5e7] dark:border-[#1f2937] text-[#1d1d1f] dark:text-white shrink-0">
      ...
      <div className="w-full bg-white dark:bg-[#111827] border border-[#e5e5e7] dark:border-[#1f2937] rounded-3xl p-6 sm:p-10 shadow-xs space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
          ...
          <div className="p-5 rounded-2xl bg-[#fbfbfd] dark:bg-[#151d2f] border border-[#e5e5e7] dark:border-[#1f2937] space-y-2.5 flex flex-col justify-between">
            ...
            <span className="text-[10px] font-bold text-[#86868b] dark:text-[#9ca3af] uppercase tracking-wider">
