      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs px-2 py-0.5 rounded bg-slate-800 text-slate-300 border border-slate-700 font-mono hidden sm:inline-block">
              {t.appTagline}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            onClick={onOpenTeam}
            className="flex items-center gap-1.5 px-3 py-1.5 min-h-[36px] rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-xs font-medium text-amber-300 transition focus-visible:ring-2 focus-visible:ring-amber-400"
          >
